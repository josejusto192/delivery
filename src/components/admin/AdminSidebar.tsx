...
const ITEMS: NavItem[] = [
  { label: 'Dashboard', soon: true, icon: <I d="M3 13h8V3H3v10zm10 8h8V11h-8v10zM3 21h8v-6H3v6zm10-12h8V3h-8v6z" /> },
  ...
  { label: 'PDV', soon: true, icon: <I d="M3 7h18M5 7V5a2 2 0 012-2h10a2 2 0 012 2v2m-1 0v12a2 2 0 01-2 2H8a2 2 0 01-2-2V7m4 5h4" /> },
  {
    label: 'Cardápio',
