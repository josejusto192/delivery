...
const ITEMS: NavItem[] = [
  ...
  { label: 'Estoque', href: '/admin/estoque', icon: <I d="M3 7l9-4 9 4-9 4-9-4zm0 0v10l9 4m0-14v14m9-14v10l-9 4" /> },
  {
    label: 'Cardápio',
  ...
  {
    label: 'Marketing',
    icon: <I d="M3 11l18-7-7 18-3-8-8-3z" />,
    children: [
      { label: 'Promoções', href: '/admin/marketing/promocoes' },
      { label: 'Fidelidade', href: '/admin/marketing/fidelidade' },
  ...
  { label: 'Financeiro', href: '/admin/financeiro', icon: <I d="M12 8c-2.2 0-4 .9-4 2s1.8 2 4 2 4 .9 4 2-1.8 2-4 2m0-8c1.7 0 3.2.5 3.8 1.3M12 8V6m0 10c-1.7 0-3.2-.5-3.8-1.3M12 16v2m9-6a9 9 0 11-18 0 9 9 0 0118 0z" /> },
  { label: 'Relatórios', href: '/admin/relatorios', icon: <I d="M8 17v-5m4 5V7m4 10v-3M5 21h14a2 2 0 002-2V5a2 2 0 00-2-2H5a2 2 0 00-2 2v14a2 2 0 002 2z" /> },
